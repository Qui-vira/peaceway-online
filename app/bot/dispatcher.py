...
def build_dispatcher() -> Dispatcher:
    ...
    from app.bot.customer import cart, catalog, checkout, followup, menu, payment, support, track
    ...
    # staff_delivery must precede staff_orders so `act:book:` isn't caught by the
    # generic `act:` handler.
