...
class NetworkPartner(Base, TimestampMixin):
    ...
    partner_type: Mapped[PartnerType] = mapped_column(
        SAEnum(PartnerType, name="partner_type"), nullable=False
    )
    channel_type: Mapped[PartnerChannel] = mapped_column(
        SAEnum(PartnerChannel, name="partner_channel"), nullable=False
    )
...
class OrderSourcing(Base, TimestampMixin):
    ...
    partner_type: Mapped[PartnerType | None] = mapped_column(SAEnum(PartnerType, name="order_partner_type"))
    sourcing_channel: Mapped[PartnerChannel | None] = mapped_column(
        SAEnum(PartnerChannel, name="order_partner_channel")
    )
